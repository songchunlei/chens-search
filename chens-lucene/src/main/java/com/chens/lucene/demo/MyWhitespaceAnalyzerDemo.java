 ...
 * @create 2018/5/6
 */
public class MyWhitespaceAnalyzerDemo extends Analyzer {
    ...
    public static void main(String[] args) {
        String text = "An AtrributeSOurce contains a list of diffent Att";
        try(Analyzer analyzer = new MyWhitespaceAnalyzerDemo();
            TokenStream ts = analyzer.tokenStream("aaa",text);
            )
        {
